<parameter name="CodeContent"># ⚡ 6-Day Industrial PLC Training Program
...
| Item | Details |
|:---|:---|
| **Duration** | 6 Days × 7 Hours = **42 Hours** of hands-on training |
...
| **Key Skills Developed** | Hardware wiring · Ladder Logic · ST Programming · Analog I/O · HMI · VFD · Fault Diagnosis |
...
- **Project**: Temperature Monitoring System with alarm logging, hysteresis & digital filter
...
| Contributor | GitHub Profile | Specialization |
|:---|:---|:---|
| **Amin Ahmed G** | [@Amin-Ahmed-G](https://github.com/Amin-Ahmed-G) | Program Lead · Day 1, 2, 4 |
| **A.M Jafrein** | [@Jafrein](https://github.com/Jafrein) | Analog & Data · Day 3, 5 |
| **M Vaishnavi** | [@robo-maker-glitch](https://github.com/robo-maker-glitch) | HMI & Capstone · Day 5, 6 |
