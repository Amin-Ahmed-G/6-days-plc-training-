...
| [`motor_set_reset.project`](motor_set_reset.project) | CODESYS project: Motor SET/RESET latch logic |
| [`motor_set_reset_st.project`](motor_set_reset_st.project) | CODESYS project: Motor SET/RESET logic in Structured Text |
